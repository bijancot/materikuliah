Selamat malang mas @...., saya mau tanya tentang aktivitas di modul 3 setelah saya coba muncul error : 

`Exception in thread "main" java.lang.NullPointerException 
        at Modul3.main(Modul3.java:13)` 

Saya kesulitan untuk menemukan sumber kesalahannya berikut source code program.
