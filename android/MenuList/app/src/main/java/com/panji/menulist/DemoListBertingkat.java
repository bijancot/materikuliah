...
public class DemoListBertingkat extends ListActivity {
    ...
    String[] menuutama = new String[] { "Versi Android","Perhitungan", "Bangun Datar", "Bangun Ruang",
            "Keluar Aplikasi" };
    String[] versiandroid = new String[] { "Tahu Telor", "Ketoprak",
            "Bakso","Rawon", "Menu Utama" };
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if (pilihan.equals("Perhitungan")) {
            ...
            this.setListAdapter(new ArrayAdapter<String>(this,
                    android.R.layout.simple_list_item_1, menuutama));
        } else if (pilihan.equals("Versi Android")) {
            this.setListAdapter(new ArrayAdapter<String>(this,
                    android.R.layout.simple_list_item_1, versiandroid));
